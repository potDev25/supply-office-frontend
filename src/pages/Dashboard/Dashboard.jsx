...
export default function Dashboard() {
  ...
  return (
    ...
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
      <CardDataStats title="Departments" total="300">
        <svg
      ...
      <CardDataStats title="Pending Documents" total="300">
        <svg
          className="fill-primary dark:fill-white"
          width="20"
          height="22"
      ...
      <CardDataStats title="Total Transaction" total="200">
        <svg
          className="fill-primary dark:fill-white"
          width="22"
          height="22"
      ...
      <CardDataStats title="Total Users" total="500">
        <svg
          className="fill-primary dark:fill-white"
          width="22"
          height="18"
