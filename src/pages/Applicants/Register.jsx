                ...
                <form action="#">
                        ...
                        <input
                          ...
                          onChange={(ev) => {
                            if (ev.target.checked) {
                              // Checkbox is checked, add the role
                              setPayload({ ...payload, role: 'supply office' });
                            } else {
                              // Checkbox is unchecked, remove the role
                              const { role, ...rest } = payload; // Remove the 'role' from the payload
                              setPayload({ ...payload, role: 'admin' });
                            }
                          }}
                  ...
                  <div className="mb-5.5">
                    ...
                    <Select
                      options={departments}
                      onChange={(ev) =>
                        setPayload({ ...payload, department_id: ev.value })
                      }
                    />
