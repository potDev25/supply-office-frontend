...
export default function AddCategoryModal({ open, handleModal, loading, handleBntLoading, handlePageLoading}) {
  ...
  const saveDepartment = async (ev) => {
    ...
    try {
      const {data} = await axiosClient.post('/category/store', payload, config)
      // setDepartments(data)
    ...
    <>
      ...
      <dialog className={`modal ${open ? 'modal-open' : ''}`}>
        <div className="modal-box">
          <h3 className="font-bold text-sm uppercase">Add Category</h3>
